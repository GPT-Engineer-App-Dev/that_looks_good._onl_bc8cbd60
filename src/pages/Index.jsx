      ...
      <Container maxW="container.md">
        <VStack spacing={5}>
          ...
          <FormControl id="desiredSize" isRequired>
            ...
            <Input name="desiredSize" value={formData.desiredSize} onChange={handleInputChange} placeholder="Enter desired size and sample locations" color="white" />
          </FormControl>
          <FormControl id="uploadSection">
            <FormLabel color="white">Upload Logo or Design</FormLabel>
            <Input type="file" name="fileUpload" accept=".vector, .pdf, .png, .bmp, .jpg, .ai, .plt" onChange={handleInputChange} color="white" />
          </FormControl>
